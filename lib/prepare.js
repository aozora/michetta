 ...
 * @param sourceDir
 * @returns {Promise<{siteConfig: {}, sourceDir: *, outDir: *, publicPath: (*|string), pageFiles: *, pagesData: null, themePath: null, notFoundPath: null}>}
 */
async function resolveOptions(sourceDir) {
  ...
  const options = {
    ...
    layout: path.resolve(sourceDir, 'layout/layout.html'),
...
async function genRoutesFile({ siteData: { pages }, sourceDir, pageFiles }) {
  ...
  console.log('genRoutesFile: pages:');
  console.dir(pages);
